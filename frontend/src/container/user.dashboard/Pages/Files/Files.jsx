...
<div className='dashboard-container w-100'>
            ...
            <div className={clsx(!mobileWidth && 'pl-4 pt-2 pb-2 pr-4', mobileWidth && 'pt-2 pb-2 pl-2')}>
                <p className={clsx(mobileWidth && 'd-heading1-res', !mobileWidth && 'pl-2', 'd-headingtop pt-2')}>Dubbing</p>
                <p className={clsx(mobileWidth && 'd-title-res', 'd-subtitle')}>Upload a video or audio, and get it dubbed in your selected language</p>
                <br></br>
                <div className='d-flex mt-4 alignselect'>
                    ...
                    <div className='d-flex flex-column position-relative'>
                        ...
                        <div className='position-absolute d-flex justify-content-center text-center mt-5 pt-2 w-100'>
                            <p className='audiocss text-center'>Dubbing Audio</p>
                        </div>
                    </div>
                </div>
